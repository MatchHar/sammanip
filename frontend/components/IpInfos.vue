...
import { getIPFromIPIP, getIPFromCloudflare_V4, getIPFromCloudflare_V6, getIPFromIpify_V4, getIPFromIpify_V6, getIPFromMyExternalIP_V4 } from '@/utils/getips';
...
// IP data cards
// Order: independent v4/v6 sources followed by additional checks.
...
const fetchIP = async (cardID, getFromSource) => {
  ...
  if (ip !== null) {
    ...
    // v6 cards in the display order: IPify v6 (1), Cloudflare v6 (3)
