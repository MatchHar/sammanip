<template>
    ...
    <!-- Advanced block (configured private source only): locked CTA for signed-out, details for signed-in. -->
...
// Advanced block only surfaces for the optional private source (ipGeoSource === 0).
